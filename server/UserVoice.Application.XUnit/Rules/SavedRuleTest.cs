...
{
    /// <inheritdoc/>
    public abstract class SavedRuleTest<TSavedRule, TEntityView> : SavedRuleTestBase<TSavedRule, TEntityView>
        where TSavedRule : class, ISavedRule<TEntityView>
        where TEntityView : class, GroupeIsa.Neos.Application.IEntityView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SavedRuleTest{TSavedRule, TEntityView}"/> class.
        /// </summary>
