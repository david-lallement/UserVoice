...
{
    /// <inheritdoc/>
    public abstract class SavingRuleTest<TSavingRule, TEntityView> : SavingRuleTestBase<TSavingRule, TEntityView>
        where TSavingRule : class, ISavingRule<TEntityView>
        where TEntityView : class, GroupeIsa.Neos.Application.IEntityView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SavingRuleTest{TSavingRule, TEntityView}"/> class.
        /// </summary>
